...
import 'package:task_manager/services/login_service.dart';
...
class _RegisterFormState extends State<_RegisterForm> {
  ...
  createAccount() async {
    ...
    loginCtrl.errorText.value = await LoginService().createUser(email: _emailController.text, password: _passwordController.text, name: _nameController.text);
  }
